...
| REQ-021 | Three distinct role experiences (Customer/Dealer/Caterpillar Admin), client-simulated role selection, no fabricated real auth | Explicit (new direction, 2026-09-01) | Must-have | `.ai/FRONTEND-REBUILD-PLAN.md`, `.ai/FRONTEND-ROLE-MATRIX.md` | `client/src/app/`, `client/src/pages/{customer,dealer,admin}/` | 28/28 backend tests; manual browser verification (Playwright, RB-7) | `VERIFIED` |
